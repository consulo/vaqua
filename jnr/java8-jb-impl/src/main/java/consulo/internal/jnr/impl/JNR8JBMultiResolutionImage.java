...
/**
 */
public class JNR8JBMultiResolutionImage extends Image implements java.awt.image.MultiResolutionImage {
    ...
    private JNR8JBMultiResolutionImage(int baseImageWidth, int baseImageHeight, @Nonnull BufferedImage im) {
