 ...
 */
public class Aqua8JBMappedMultiResolutionImage extends Image implements MultiResolutionImage {

    private final Image baseImage;
    private final MyVariantMapper mapper;
    private int availableInfo;

    public Aqua8JBMappedMultiResolutionImage(MultiResolutionImage source, Function<Image,Image> mapper) {
    ...
    public Aqua8JBMappedMultiResolutionImage map(Function<Image, Image> mapper) {
        return new Aqua8JBMappedMultiResolutionImage(this, mapper);
    }
