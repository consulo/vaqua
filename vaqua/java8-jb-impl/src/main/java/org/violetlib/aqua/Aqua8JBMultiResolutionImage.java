 ...
 */
public class Aqua8JBMultiResolutionImage extends AquaMultiResolutionImage implements MultiResolutionImage {

    public Aqua8JBMultiResolutionImage(BufferedImage im) {
        super(im);
    }

    public Aqua8JBMultiResolutionImage(int width, int height, BufferedImage im) {
    ...
    public AquaMultiResolutionImage map(Mapper mapper) {
        return new Aqua8JBMultiResolutionImage(mapper.map(baseImage, 1));
    }

    @Override
    public AquaMultiResolutionImage map(Function<Image, Image> mapper) {
        return new Aqua8JBMultiResolutionImage(Images.toBufferedImage(mapper.apply(baseImage)));
    }
    ...
    public static Image apply(Image source, Function<Image,Image> mapper) {
        if (source instanceof Aqua8JBMappedMultiResolutionImage) {
            Aqua8JBMappedMultiResolutionImage s = (Aqua8JBMappedMultiResolutionImage) source;
        ...
        if (source instanceof MultiResolutionImage) {
            ...
            return new Aqua8JBMappedMultiResolutionImage(s, mapper);
        }
