...
public class Aqua8JBMultiResolutionImage2 extends AquaMultiResolutionImage implements MultiResolutionImage {
    private final BufferedImage im1;
    private final BufferedImage im2;

    public Aqua8JBMultiResolutionImage2(BufferedImage im1, BufferedImage im2) {
        super(im1);
        this.im1 = im1;
        this.im2 = im2;
    }
    ...
    public AquaMultiResolutionImage map(Mapper mapper) {
        ...
        return new Aqua8JBMultiResolutionImage2(m1, m2);
    }
