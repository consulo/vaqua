 ...
 * Merged with JDK 9 on 2015-07-17.
 */
...
// UI Installation/De-installation
    ...
    protected void installKeyboardActions() {
        ...
        LazyActionMap.installLazyActionMap(tabPane, AquaTabbedPaneCopyFromBasicUI.class,
    ...
    private void addMnemonic(int index, int mnemonic) {
        ...
        mnemonicInputMap.put(KeyStroke.getKeyStroke(mnemonic, Event.ALT_MASK | Event.CTRL_MASK),
                "setSelectedIndex");
...
// UI Rendering
    ...
    protected void paintTab(Graphics g, int tabPlacement,
        ...
        FontMetrics metrics = AquaUtils.getFontMetrics(tabPane, g, font);
...
// Tab Navigation methods
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            AquaTabbedPaneCopyFromBasicUI ui = (AquaTabbedPaneCopyFromBasicUI)getUIOfType(pane.getUI(), AquaTabbedPaneCopyFromBasicUI.class);
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            AquaTabbedPaneCopyFromBasicUI.this.paintTabArea(g, tabPane.getTabPlacement(),
